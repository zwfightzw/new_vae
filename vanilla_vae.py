...
class Trainer(object):
    ...
    def style_transfer(self, epoch):
        with torch.no_grad():
            ...
            os.makedirs(os.path.dirname('./Factorised/transfer/epoch%d/image1_body_image2_motion.png' % epoch),
                        exist_ok=True)
            torchvision.utils.save_image(image1_body_image2_motion,
                                         './Factorised/transfer/epoch%d/image1_body_image2_motion.png' % epoch)
            torchvision.utils.save_image(image2_body_image1_motion,
                                         './Factorised/transfer/epoch%d/image2_body_image1_motion.png' % epoch)
    '''
